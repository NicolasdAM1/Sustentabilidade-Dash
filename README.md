# 🌍 Dashboard de Sustentabilidade: Monitor de CO2

Este projeto é um dashboard interativo desenvolvido em Python para visualizar e analisar as emissões globais de dióxido de carbono (10%) com base nos dados do Our World in Data.
...
Para testar o dashboard na sua própria máquina, siga os passos abaixo:
    ...
    Clone este repositório no seu terminal com o comando git clone https://github.com/NicolasdAM1/sustentabilidade-dash.git

    Garanta que você tenha o Python instalado.

    Instale as bibliotecas necessárias usando o comando pip install -r requirements.txt

    Inicie a aplicação com o comando streamlit run app.py
